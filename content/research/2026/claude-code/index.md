...
- Supports **headless/CI mode**[^4] for non-interactive use in pipelines and automation.
...
[^4]: [Claude Code SDK (npm)](https://www.npmjs.com/package/@anthropic-ai/claude-code)
